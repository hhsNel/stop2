...
/*	 element type        argument                                                   input          foreground                          background */
	{EL_MENU_BUTTON,    {.v="menu btn",.i=sizeof(help_menu)/sizeof(*help_menu)},    help_menu,     {.color_mode=CLRM_USR,.clr=7},      {.color_mode=CLRM_USR,.clr=0}},
	...
	{EL_PLAINTEXT,      {.v="sTop poc v0.0.1"},                                     NULL,          {.color_mode=CLRM_USR,.clr=4},      {.color_mode=CLRM_USR,.clr=0}},
	{EL_H_CAP,          {.i=1},                                                     NULL,          {},                                 {}},
